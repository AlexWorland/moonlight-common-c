...
static void fakeClRtspFeatures(const char* features) {}
...
static CONNECTION_LISTENER_CALLBACKS fakeClCallbacks = {
    ...
    .rtspFeatures = fakeClRtspFeatures,
};
    ...
    PCONNECTION_LISTENER_CALLBACKS* clCallbacks)
{
    ...
    if (*clCallbacks == NULL) {
        *clCallbacks = &fakeClCallbacks;
        ...
        if ((*clCallbacks)->rtspFeatures == NULL) {
            (*clCallbacks)->rtspFeatures = fakeClRtspFeatures;
        }
    }
}
